...
import balatro_ai_v2.solver.jackdaw as jackdaw
...
from balatro_ai_v2.solver.public_state import HiddenJokerSlot, PublicShopPlayingCard
from solver_state_factory import item_card, state


def _candidate_playing_card(raw_card: dict[str, object], **ability: object) -> object:
    pytest.importorskip("jackdaw", reason="optional Python 3.12 candidate dependency")
