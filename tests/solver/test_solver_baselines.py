...
from balatro_ai_v2.solver.boss_rules import boss_rule
from balatro_ai_v2.solver.build_strategy import BuildPlan
...
from balatro_ai_v2.solver.policy import NoPublicProgressAction
from balatro_ai_v2.solver.strategy_options import StrategyIntent
...
def test_boss_eligibility_classifies_only_for_hand_family_rules(
    ...
    monkeypatch.setattr(
        "balatro_ai_v2.solver.baselines._classify", unexpected_classification
    )
