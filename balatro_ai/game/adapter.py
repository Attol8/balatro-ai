...
def to_public_observation(raw: Mapping[str, Any]) -> PublicObservation:
    ...
    deck_size = sum(full_deck_counts.values())
    ...
    return PublicObservation(
        ...
        # BalatroBot's cards.limit is the starting area capacity and can stay
        # at 52 after public deck growth or thinning. The validated public
