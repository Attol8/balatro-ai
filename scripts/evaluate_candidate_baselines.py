...
TERMINAL_PROJECTION_SCHEMA_VERSION = 1
...
def main() -> None:
    ...
    try:
        ...
        if args.fitness_only:
            print(json.dumps({"fitness": summary["survival_to_ante_6_rate"]}))
        else:
            print(encoded)
...
def summarize_results(
    ...
    *,
    ...
    """Summarize outcomes with survival as the primary development signal."""
